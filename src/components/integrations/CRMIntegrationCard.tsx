  ...
  return (
    <Card className="w-full">
      <CardHeader className="pb-2">
        ...
        <CardDescription>CRM system integration</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="text-sm">
            <p className="mb-2">
              Integrate with {provider} to sync customer relationship data and streamline your sales processes.
            </p>
          </div>
        </div>
      </CardContent>
