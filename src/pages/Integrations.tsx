...
import { Info, PuzzleIcon } from "lucide-react";
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <Alert className="mb-6">
        ...
        <AlertDescription>
          ...
          Use the new <Link to="/integrations/hub" className="font-medium underline">Integration Hub</Link> for advanced AI-driven integrations.
        </AlertDescription>
      </Alert>
